...
function createEnterpriseFloorLayout(): OfficeLayoutData {
  ...
  return {
    ...
    rooms: [
      ...
      { id: 'break-main', name: 'Main Cafeteria', type: 'break', bounds: { x: 1600, y: 992, width: 384, height: 288 }, capacity: 40, equipment: ['coffeeMachine', 'fridge', 'microwave', 'vending-machines'], bookable: false, status: 'available', color: '#fff3e0', borderColor: '#ff9800' },
    ...
    decorations: [
      ...
      { id: 'plant-2', type: 'plantLarge', position: { x: 736, y: 48 }, dimensions: { width: 48, height: 48 } },
      { id: 'plant-3', type: 'plantLarge', position: { x: 1184, y: 48 }, dimensions: { width: 48, height: 48 } },
      { id: 'plant-4', type: 'plantLarge', position: { x: 1696, y: 48 }, dimensions: { width: 48, height: 48 } },
      { id: 'plant-5', type: 'plantLarge', position: { x: 2464, y: 48 }, dimensions: { width: 48, height: 48 } },
      { id: 'plant-6', type: 'plantMedium', position: { x: 48, y: 1504 }, dimensions: { width: 36, height: 36 } },
      { id: 'plant-7', type: 'plantMedium', position: { x: 832, y: 1504 }, dimensions: { width: 36, height: 36 } },
      ...
      { id: 'coffee-main', type: 'coffeeMachine', position: { x: 1632, y: 1024 }, dimensions: { width: 48, height: 48 }, interactive: true, interactionRadius: 80 },
