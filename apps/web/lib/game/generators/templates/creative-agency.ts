  ...
  return {
    ...
    rooms: [
      ...
      // Kitchen/Break area
      {
        ...
        capacity: 12,
        equipment: ['coffee-machine', 'fridge', 'microwave', 'kitchen-island'],
        bookable: false,
        status: 'available',
        color: '#fff3e0',
        borderColor: '#ff9800',
    ...
    decorations: [
      ...
      // Kitchen area
      { id: 'coffee-1', type: 'coffee-machine', position: { x: 960, y: 576 }, dimensions: { width: 48, height: 48 }, interactive: true, interactionRadius: 80 },
