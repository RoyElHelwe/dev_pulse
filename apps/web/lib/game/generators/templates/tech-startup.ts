...
function createTechStartupLayout(): OfficeLayoutData {
  ...
  return {
    ...
    decorations: [
      ...
      { id: 'collab-table-1', type: 'conference-table', position: { x: 320, y: 600 }, dimensions: { width: 96, height: 64 } },
      ...
      // Coffee station
      { id: 'coffee-1', type: 'coffee-machine', position: { x: 896, y: 480 }, dimensions: { width: 48, height: 48 }, interactive: true, interactionRadius: 80 },
      ...
      { id: 'armchair-1', type: 'lounge-chair', position: { x: 1088, y: 700 }, dimensions: { width: 64, height: 64 } },
